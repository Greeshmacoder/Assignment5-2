<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="studentreg.aspx.cs" Inherits="Studentform.studentreg" %>
...
<body>
    <center><h2> Student Register form</h2></center>
    ...
    <center>
                <asp:Label ID="Label5" runat="server" Text="Hobbies  : "></asp:Label> <asp:CheckBoxList ID="CheckBoxList1" runat="server" RepeatDirection="Horizontal" Height="16px" Width="114px" >
                       <asp:ListItem> Reading</asp:ListItem>
                       
                       <asp:ListItem> Paniting </asp:ListItem> 
                       <asp:ListItem> Rideing</asp:ListItem>
       ...
       <br />
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:Label ID="Label7" runat="server" Text="COURSES : "> </asp:Label> <asp:DropDownList ID="Dd1" runat="server" Height="42px" Width="201px">
